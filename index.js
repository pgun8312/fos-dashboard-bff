...
const options = {
    ...
    apis: ['./controllers/orderController.js','./controllers/userController.js','./controllers/productController.js'],
};
...
app.listen(port, () => {
    ...
    console.log(`Swagger docs can access from here: http://localhost:${port}/api-docs`);
})
